...
class ProductFixtures extends Fixture
{
  public function load(ObjectManager $manager): void
  {
    ...
    $hygiene->setImagePath('images/products/hygiene.jpg');
    ...
    $shot->setImagePath('images/products/green-shot.jpg');
    ...
    $gourde->setImagePath('images/products/dark-gourde.jpg');
    ...
    $disque->setImagePath('images/products/disque.jpg');
    ...
    $bougie->setImagePath('images/products/bougie.jpg');
    ...
    $brosse->setImagePath('images/products/brosse.jpg');
    ...
    $couvert->setImagePath('images/products/couvert.jpg');
    ...
    $deodorant->setImagePath('images/products/deodorant.jpg');
    ...
    $savon->setImagePath('images/products/savon.jpg');
